import { Play, ChevronDown, Link2, AlertCircle, Sparkles, FileText, Search, X } from 'lucide-react';
            ...
            <div className="relative" ref={dropdownRef}>
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2.5 pr-10 bg-white border border-slate-200 rounded-lg text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
